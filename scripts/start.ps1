...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint aobdkg2h0ih0r-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert Abhinavs_Legion.cert.pem --key Abhinavs_Legion.private.key --client_id basicPubSub --topic sdk/test/Python --count 0